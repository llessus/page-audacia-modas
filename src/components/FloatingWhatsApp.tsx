...
export function FloatingWhatsApp() {
  const whatsappUrl = `https://wa.me/${siteConfig.whatsappDDIeDDD}?text=${encodeURIComponent(
    'Olá! Gostaria de tirar uma dúvida sobre as roupas.'
  )}`;
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-[90] p-4 bg-[#25D366] text-white rounded-full shadow-[0_10px_30px_rgba(37,211,102,0.4)] hover:shadow-[0_15px_40px_rgba(37,211,102,0.5)] transition-all duration-300 group"
